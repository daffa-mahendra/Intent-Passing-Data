package com.example.intent_passing_data;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_move_with_data_activity:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Daffa Mahendra Al Harizts");
            ...
            case R.id.btn_move_activity_object:
                ...
                mPerson.setName("Daffa Mahendra Al Harizts");
                mPerson.setAge(17);
                mPerson.setEmail("daffamahendra33@@gmail.com");
            ...
            case R.id.btn_dial_number:
                String phoneNumber = "085523841433";
